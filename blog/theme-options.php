													...
													<table>
														...
														<tr>
															<td class="option-left">
																...
																?>
																<textarea id="theme_tagline" name="theme_tagline" rows="1" cols="50"><?php echo $theme_tagline; ?></textarea>
															</td>
															<td class="option-right">
																Select tagline.
															</td>
												...
												<form class="ajax-form" method="post" action="<?php admin_url( 'themes.php?page=theme-options' ); ?>">
													...
													<table>
														<tr>
															...
															<td class="option-right">
																Select colors and fonts from live theme customizer.
															</td>
														</tr>
														<tr>
															<td class="option-left">
																<h4>Nav Menu Search</h4>
																<?php
															...
															<td class="option-right">
																Show or hide the search module in the navigation menu.
															</td>
														</tr>
												...
												<form class="ajax-form" method="post" action="<?php admin_url( 'themes.php?page=theme-options' ); ?>">
													...
													<table>
														...
														<tr>
															...
															<td class="option-right">
																Deactivate default contact form to use third party contact form plugin.
															</td>
														</tr>
														<tr>
															<td class="option-left">
